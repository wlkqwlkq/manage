...
export default {
  ...
  mounted() {
    ...
    if(type == 'zhuce'){
      ...
      document.getElementsByClassName('qrpw')[0].style.display = "block"
      ...
      document.getElementsByClassName('qrpw')[0].style.display = "none"
    }
  },
  methods:{
    login(){
      ...
      axios({
        method:'post',
        url:'http://localhost:63342/untitled/request/login.php?_ijt=dha1nb8bnthtqslf4pdvvpmu0u',
        data:user
      }).then((res)=>{
        console.log(res)
    ...
    zhuce(){
      ...
      axios({
        method:'post',
        url:'http://localhost:63342/untitled/request/zhuce.php',
        data:user
      }).then((res)=>{
        console.log(res)
      }).catch((err)=>{
